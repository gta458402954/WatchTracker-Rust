...
- `TASK-B-005`: Owner `Codex`; Status `READY`; BASE `62cdd53` on the canonical integration branch. Scope is full regression and isolated release-desktop evidence only; no product change or acceptance conclusion is authorized in the Implementation Pass.
