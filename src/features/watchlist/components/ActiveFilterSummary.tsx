...
export default function ActiveFilterSummary({ items, onRemove, onClear }: {
  ...
  return <div aria-label="当前筛选条件" className="border-b border-indigo-100 bg-indigo-50/60 px-4 py-2">
    <div className="mx-auto flex max-w-5xl flex-wrap items-center gap-2">
      <span className="text-xs font-bold text-indigo-700">当前条件</span>
      ...
      <button type="button" onClick={onClear} className="ml-auto text-xs font-bold text-gray-500">清除全部</button>
    </div>
  </div>;
}
